...
public class HandlerPedicure implements Handler {

    private Handler siguiente;
    private String especialidad;
    private boolean disponible;

    public HandlerPedicure(String especialidad, boolean disponible) {
    ...
    public boolean puedeManejar(Solicitud solicitud) {
        return disponible && solicitud.getDescripcion().toLowerCase().contains("pedicure");
    }
}
